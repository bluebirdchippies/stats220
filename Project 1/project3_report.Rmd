...
selected_photos <- read_csv("/Users/kobibornilla/Desktop/STATS 220/stats220/Project 3/selected_photos.csv")
```
...
I picked these two words because I really like Lemurs and wanted a random adjective. So I picked "Cool". I felt like if I used a more niche or distinct adjective then I wouldn't get many good results. Also Lemurs are cool so it's a redundant term in my books.

![Cool Lemurs]("https://www.pexels.com/search/cool%20lemurs/") 
![Image of Lemurs]("/Users/kobibornilla/Desktop/STATS%20220/stats220/Project%203/screenshotoflemurs.png")

All photos generally show lemurs in their natural habitat. Some, but not many, of the photos show them in enclosures. They are mostly candid photos, though sometimes the lemur would notice the photographer and look into the camera. There is also a good mix of photos that are taken landscape vs portrait.
...
![My Meme]("%22/Users/kobibornilla/Desktop/STATS%20220/stats220/Project%203/creativity.gif%22")

I wasn't too creative this time. But in journey to create a meme, I needed to be able to zoom into the image because I needed to emphasies that the lemur is looking in the direction of the camera. So I looked for another magick function that could let me do this. I really enjoyed making this meme like usual.
